...
console.log(
    [
        include(domain_terminator, [
            ["browser", [
                `each module have own subdomain ( perfobyte.module.url )`,
            ]]
        ]),
        ...
        "PerfoByte compiled and extended JavaScript (ECMA script) "
        +"as cross-platform decision for module",

        "Making own cross-platform application based on PerfoByte SDK (client)",
    ]
    .join("\n\n\n\n")
)
